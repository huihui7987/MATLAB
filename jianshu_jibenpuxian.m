clear all;
Np=1001;
lambda=linspace(1445e-9,1455e-9,Np);
...
subplot(2,3,5)
plot(lambda,T,'--b','linewidth',1.8)
hold on
plot(lambda,T5,'--b','linewidth',1.8)
hold on
plot(lambda,T6,'--b','linewidth',1.8)
hold on
plot(lambda,T7,'--b','linewidth',1.8)
legend('t=0.99','t=0.98','t=0.97','t=0.96')
xlabel('wavelength')
ylabel('normalized power(a.u.)')